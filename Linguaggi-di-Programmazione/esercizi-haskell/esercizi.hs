...
-- 2.versione_1 Scrivere una funzione che calcola la somma degli elementi di posizione dispari di una lista
...
-- 2.versione_2 Scrivere una funzione che calcola la somma degli elementi di posizione dispari di una lista
...
{----------------------------------------x MATRICI x----------------------------------------}
-- 1. Si scriva una funzione matrixDim che data una matrice ne calcola le dimensioni, se la matrice e' ben formata, 
...
-- 9. Si scriva una funzione che data una matrice di dimensioni m × n restituisce la corrispondente

...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 0.2.1_Ricorsione_calcolo_misure_foglio_con_cond) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; s(k) lunghezza del lato piu lungo del formato Ak
;; s(k+2) = s(k)/ 2

;; s(0) = s0 -> lato piu lungo formato A0
;; s(1) = s1 -> lato piu corto formato A0 (= lato piu lungo formato A1)
